...
function App() {
  ...
  function checkForDuplicates(arr) {
    const hasDuplicates = arr.filter(
      (item, index) =>
        arr.findIndex(
          (obj) => obj.gegenstand === item.gegenstand && obj.wert === item.wert
        ) !== index
    );
        ...
        <div id="popUpContainer">
              ...
              return (
                <div className="fullAddedItem">
                  ...
                  <input
                    ...
                    onChange={($event) =>
                      setWert(toNumber($event.target.value))
                    }
          ...
          <button
            ...
            onClick={() => {
              ...
              if (check) {
                alert(
                  "Versichern Sie sich, dass keine Duplikate vorhanden sind oder bennenen Sie den Gegenstand um, um Verwirrung zu vermeiden"
                );
              } else {
                setActive(false);
                sumUpAndSelect();
      ...
      <header className="App-header">
          ...
          {step === 1 ? (
            <div className="inputKasten">
              <MyInput
                ...
                hoverText="Die Versicherungssumme wurde mit ihrem Versicherungsberater abgemacht. Sie beschreibt den abgemachten Wert ihres Hausrates."
                value={vsSumme}
                onChange={setVsSumme}
                step={step}
                setStep={setStep}
            ...
            <div className="inputKasten">
              <MyInput
                ...
                hoverText="Der Versicherungswert beschreibt den momentanen Wert ihres Hausrates. Er kann von der Versicherungsumme abweichen."
                value={vsWert}
                onChange={setVsWert}
                step={step}
                setStep={setStep}
            ...
            <div className="inputKasten">
              <MyInput
                title="Schaden"
                hoverText="Der Schaden ist der Wert, der gebraucht wird, um die beschädigte Einrichtung zu ersetzen."
                value={schaden}
                onChange={setSchaden}
                step={step}
                setStep={setStep}
            ...
            <div id="lastSide">
              <p>
                Ihre Versicherung wird{" "}
                <b>
                  {Math.round((vsSumme / vsWert) * 100 * 100) / 100 >= 100
                    ? 100
                    : Math.round((vsSumme / vsWert) * 100 * 100) / 100}
                  %
                </b>{" "}
                des Schadens übernehmen
              </p>
              <p>
                Ihre Versicherung wird{" "}
                <b>
              ...
              {vsSumme > vsWert ? (
                ...
                <>
                  <p className="vsWarnung">
                    WARNUNG: Sie sind unterversichert!
                  </p>
                </>
              ) : (
                ""
        ...
        <div id="werteContainer">
          <p>
            ...
            <span className="werteVariables">
              <b>{toOutString(vsSumme)}</b> CHF
            </span>
          </p>
          <br />
          <p>
